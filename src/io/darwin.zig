...
pub const IO = struct {
    ...
    pub fn init(entries: u12, flags: u32) !IO {
        ...
        // braingang patch: 0.16 std API drift — std.posix.kqueue was removed,
        // so we call libc's kqueue(2) directly. See UPSTREAM.md.
    ...
    pub fn deinit(self: *IO) void {
        assert(self.kq > -1);
        // braingang patch: 0.16 std API drift — std.posix.close was removed,
        // so we call libc's close(2) directly. See UPSTREAM.md.
